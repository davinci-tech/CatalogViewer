    ...
    <div className="container mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <header className="mb-10 text-center">
        ...
        <p className="text-md sm:text-lg text-muted-foreground">
          Welcome! View your academic performance summary by subject. Click on a card for details. The data was last fetched on {lastFetched ? new Date(lastFetched).toLocaleString('en-GB', {month: "long", day:"2-digit", hour: "numeric", minute: "numeric", second: "numeric"}) : 'unknown'}.
        </p>
      </header>
